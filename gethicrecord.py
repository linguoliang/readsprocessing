...
def reversecomp(string):
    string=string[::-1].replace("A","P").replace("T","A").replace("P",'T').replace("G","P").replace("C","G").replace("P",'C')
    return string
                ...
                if (flag1 or flag2) and len(data['1'])==2:
                    ...
                    if distanc.min()<=1000:
                        if count==4:
                            ...
                            if index[0]!=index[1]:
                                if distanc[0,3-index[0]-index[1]]>=1000000000 and distanc[1,3-index[0]-index[1]]>=1000000000:
                                    if distanc[0,index[0]]<1000:
                                        writetodisk(data['1'][0],data['2'][index[0]],data['2'][3-index[0]-index[1]],outputfile)
                                    ...
                                    if distanc[1,index[1]]<1000:
                                        writetodisk(data['1'][1],data['2'][index[1]],data['2'][3-index[0]-index[1]],outputfile,"lin1")
